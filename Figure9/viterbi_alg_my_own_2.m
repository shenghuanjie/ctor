...
%apriori_probs( , )=   %the apriori probabilities; these are P[b_{k+1}| b_{k}] in my draft
                       %each of these would be equal to 1/(L^2) if you were going to consider the uniform priors into the alg
...
%lambda(t2,t1,1,1)=
lambda(2,1,1,1)=-log(P(input_stream2(1,1),1))-log(P(input_stream2(1,2),1))-log(P(input_stream2(1,3),1)); 
lambda(2,1,3,1)=-log(P(input_stream2(1,1),2))-log(P(input_stream2(1,2),2))-log(P(input_stream2(1,3),2)); 
...
%lambda(t2,t1,1,1)=
lambda(3,2,1,1)=-log(P(input_stream2(2,1),1)) -log(P(input_stream2(2,2),1)) -log(P(input_stream2(2,3),1)); 
lambda(3,2,3,1)=-log(P(input_stream2(2,1),2)) -log(P(input_stream2(2,2),2)) -log(P(input_stream2(2,3),2)); 
lambda(3,2,2,3)=-log(P(input_stream2(2,1),2)) -log(P(input_stream2(2,2),1)) -log(P(input_stream2(2,3),2)); 
lambda(3,2,4,3)=-log(P(input_stream2(2,1),1)) -log(P(input_stream2(2,2),2)) -log(P(input_stream2(2,3),1)); 
 ...
 %m=1;
  %while(m <= M_max)   %m loop (begin)
   ...
   %while(n <= N_max)   %t1 is the block number below, n is the index within the block and is n=1,2,3 here, hence the sum of 3 terms below
    ...
    lambda(t2,t1,1,1)=-log(P(input_stream2(t1,1),1)) -log(P(input_stream2(t1,2),1)) -log(P(input_stream2(t1,3),1)); 
    lambda(t2,t1,3,1)=-log(P(input_stream2(t1,1),2)) -log(P(input_stream2(t1,2),2)) -log(P(input_stream2(t1,3),2)); 
    lambda(t2,t1,1,2)=-log(P(input_stream2(t1,1),1)) -log(P(input_stream2(t1,2),2)) -log(P(input_stream2(t1,3),2)); 
    lambda(t2,t1,3,2)=-log(P(input_stream2(t1,1),2)) -log(P(input_stream2(t1,2),1)) -log(P(input_stream2(t1,3),1)); 
    lambda(t2,t1,2,3)=-log(P(input_stream2(t1,1),2)) -log(P(input_stream2(t1,2),1)) -log(P(input_stream2(t1,3),2)); 
    lambda(t2,t1,4,3)=-log(P(input_stream2(t1,1),1)) -log(P(input_stream2(t1,2),2)) -log(P(input_stream2(t1,3),1)); 
    lambda(t2,t1,2,4)=-log(P(input_stream2(t1,1),2)) -log(P(input_stream2(t1,2),2)) -log(P(input_stream2(t1,3),1));
    lambda(t2,t1,4,4)=-log(P(input_stream2(t1,1),1)) -log(P(input_stream2(t1,2),1)) -log(P(input_stream2(t1,3),2));
